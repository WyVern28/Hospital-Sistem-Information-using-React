...
export default function Header({ page, session, onNavigate, onLogout }: { page: Page; session: AuthSession | null; onNavigate: (page: Page) => void; onLogout: () => void }) {
  ...
  return <header className="site-header">
    <button className="brand" onClick={() => go('home')} aria-label="Beranda Anahita Hospital"><img className="brand-logo" src="/Group%201.png" alt="" /><span className="brand-copy">Anahita Hospital</span></button>
